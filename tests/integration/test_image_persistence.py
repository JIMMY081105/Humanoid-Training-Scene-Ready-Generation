...
class TestImagePersistence(unittest.TestCase):
    ...
    def test_multiple_observe_scene_calls_accumulate_images(self):
        ...
        2. Start a new agent turn, reset the within-turn observation guard, call
           observe_scene again in the same session, and count total
        ...
        try:
            ...
            vision_tools.reset_observation_guard()
            asyncio.run(
                Runner.run(
                    starting_agent=agent,
