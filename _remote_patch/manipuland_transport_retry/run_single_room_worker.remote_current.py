...
def main() -> None:
    ...
    # SystemExit instead of letting the default handler bypass the ``finally``
    # below, which would otherwise leak worker services and their reserved
    # ports into the next checkpoint-resume attempt.
