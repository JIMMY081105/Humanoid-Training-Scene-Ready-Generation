...
while true; do
  ready=1
  for room in classroom_05 classroom_06 boys_toilet girls_toilet main_corridor; do
...
dependencies=(168972 168974 168975)
for receipt in "$CLASSROOM04_GATE_RECEIPT" "$STORAGE_GATE_RECEIPT" "$ROOM1_RECEIPT"; do
