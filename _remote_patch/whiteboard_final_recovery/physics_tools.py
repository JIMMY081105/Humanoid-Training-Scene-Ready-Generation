...
def check_physics_violations(
    ...
    manipuland_scope_ids: set[UniqueID] | None = None,
) -> str:
    ...
    collisions = compute_scene_collisions(
        scene=clone_scene_with_collision_repairs(scene),
        ...
        manipuland_scope_ids=manipuland_scope_ids,
    )
