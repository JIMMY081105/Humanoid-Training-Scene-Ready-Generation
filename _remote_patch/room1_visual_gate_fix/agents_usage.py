...
def _empty_input_tokens_details(*, cached_tokens: int = 0) -> InputTokensDetails:
    """Bridge Agents 0.17.4 to OpenAI SDKs that require cache_write_tokens."""
...
def deserialize_usage(usage_data: Mapping[str, Any]) -> Usage:
    ...
    input_details = _coerce_token_details(
        ...
        input_tokens_details_raw or {"cached_tokens": 0, "cache_write_tokens": 0},
        _empty_input_tokens_details(),
    )
        ...
        request_entries.append(
            RequestUsage(
                ...
                input_tokens_details=_coerce_token_details(
                    TypeAdapter(InputTokensDetails),
                    entry.get("input_tokens_details")
...
def _normalize_input_tokens_details(
    ...
    if v is None:
        return _empty_input_tokens_details()
    if isinstance(v, PromptTokensDetails):
        return _empty_input_tokens_details(cached_tokens=v.cached_tokens or 0)
    return v
...
class Usage:
    ...
    ] = field(default_factory=_empty_input_tokens_details)
    ...
    def __post_init__(self) -> None:
        ...
        if input_details_none or input_cached_none:
            self.input_tokens_details = _empty_input_tokens_details()
    ...
    def add(self, other: Usage) -> None:
        ...
        if other.request_usage_entries:
            ...
            input_details = other.input_tokens_details or _empty_input_tokens_details()
