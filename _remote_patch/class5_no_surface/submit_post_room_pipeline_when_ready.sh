...
while true; do
  ready=1
  for room in classroom_06 boys_toilet girls_toilet main_corridor; do
...
dependencies=()
for receipt in "$CLASSROOM04_GATE_RECEIPT" "$STORAGE_GATE_RECEIPT" "$CLASSROOM05_GATE_RECEIPT" "$CLASSROOM02_GATE_RECEIPT" "$CLASSROOM03_GATE_RECEIPT" "$LIBRARY_GATE_RECEIPT" "$ROOM1_RECEIPT"; do
